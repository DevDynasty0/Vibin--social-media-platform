      ...
      <div className="max-w-2xl mx-4 h-96 w-10/12 sm:max-w-sm md:max-w-sm lg:max-w-sm xl:max-w-sm sm:mx-auto md:mx-auto lg:mx-auto xl:mx-auto mt-1 bg-white shadow-xl rounded-lg text-gray-900">
          ...
          <div>
            <div className="rounded-t-lg h-32 overflow-hidden">
              <img
                ...
                src={
                  user?.profile?.coverImage ? user?.profile?.coverImage : cover
                }
                alt="Mountain"
              ></img>
            </div>
        ...
        <div className="p-4 border-t mx-8 mt-2 flex flex-wrap md:flex-nowrap lg:flex-wrap xl:flex-nowrap  gap-3">
          <button
            ...
            className="xl:w-1/2 w-full  mx-auto rounded-full bg-color-one hover:shadow-lg font-semibold text-white px-2 py-2"
          >
            Unfollow
          </button>
          <button
            onClick={handleBlock}
            className="xl:w-1/2 w-full  mx-auto rounded-full bg-white border-2 border-color-one hover:shadow-lg font-semibold text-black px-2 py-2"
          >
            Block
          </button>
        </div>
