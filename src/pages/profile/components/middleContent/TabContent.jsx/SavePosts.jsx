    ...
    <div>
      <div>
        {data && data.length > 0 ? (
                  ...
                  <div key={savepost._id}>
                    <Link to="/savePost">
                      <div className="bg-white  p-2 rounded-md shadow-md h-[200px]">
                        <img
                          className="bg-white w-full rounded-md  h-full object-cover cursor-pointer"
                          src={savepost.postContent}
                          alt=""
                        />
                      </div>
                    </Link>
          ...
          // </div>
          <div className=" flex-col  flex items-center justify-center text-center mt-[30%]">
            {" "}
            <FaBookmark className="text-white text-6xl  "></FaBookmark>
